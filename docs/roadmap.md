...
CampaignLens v1.0.2 is the latest release. The hackathon launch (v1.0.1) delivered deterministic campaign detection, explainable dossiers, review workflow, guarded moderation actions, and Reddit-ready Expanded Mode.
...
These items are intentionally outside v1.0.2 because they need deeper safety review:
